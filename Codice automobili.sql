...
-- trovare tutte le auto che non siano fiat e ford:
select * from automobili where marca not in ('fiat', 'ford');

-- trovare tutte le auto fiat e ford:
select * from automobili where marca in ('fiat', 'ford');

-- trovare tutte le auto che iniziano con f:
select * from automobili where marca like 'f%';

-- trovare tutte le auto che abbiamo una marca da 5 caratteri:
select * from automobili where marca like '_____';

-- trovare le auto in cui la marca finisca con 'da':
select * from automobili where marca regexp 'da$';

-- trovare le auto in cui la marca inizia con 'ma':
select * from automobili where marca regexp '^ma';
