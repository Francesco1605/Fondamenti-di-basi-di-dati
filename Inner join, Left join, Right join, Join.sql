...
(20,'Una storia tra due citt├á',9.77,600,10),
(21,'Marcovaldo',10.00,120,7),
(22,'IT',25.00,550,9),
(23,'gomorra',12.59,345,1);
select * from libro;

INSERT INTO `editore` VALUES (1,'Mondadori','info-mondadori@gmail.com'),
...
select * from libro, editore where libro.editore_id = editore_id;

select l.titolo as 'Titolo del libro', e.nome as "Nome dell'editore" from libro as l, editore as e where l.editore_id = e.id;

-- oppure

select l.titolo as 'Titolo del libro', e.nome as "Nome dell'editore" from libro as l inner join editore as e on l.editore_id = e.id;
...
insert into impiegati (nome, responsabile) values 
('giovanni', null),
('francesca', 1),
('gianni', 2),
('pippo', 1);

select i.nome, e.nome from impiegati as i left join impiegati as e on i.responsabile = e.id;
